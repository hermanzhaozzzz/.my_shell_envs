...
require("mason-lspconfig").setup({
    ...
    ensure_installed = {
        ...
        "pyright"                          -- Python, 退出conda环境后，brew install node pyright
    },
})
...
--     notify(utils.exepath("python"), notify.INFO, { title = 'lsp-info: your pythonPath' })
--     notify(utils.exepath("pyright"), notify.INFO, { title = 'lsp-info: your pyrightPath' })
--     lspconfig.pyright.setup({
--         capabilities = capabilities
...
--     })
-- else
--     notify("pyright not found!", notify.WARN, { title = 'lsp-info' })
-- end
